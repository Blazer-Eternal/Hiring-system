...
exports.computeMatch = computeMatch;
exports.rankJobsForCandidate = rankJobsForCandidate;
exports.rankCandidatesForJob = rankCandidatesForJob;
...
function matchCountToScore(uniqueMatchCount) {
...
function buildVector(tokens, idf) {
    ...
    for (const [term, tfVal] of tf)
        vec.set(term, tfVal * ((_a = idf.get(term)) !== null && _a !== void 0 ? _a : 1));
    return vec;
}
function cosineSimilarity(a, b) {
    ...
    for (const [t, v] of a) {
        dot += v * ((_a = b.get(t)) !== null && _a !== void 0 ? _a : 0);
        normA += v * v;
    }
    for (const [, v] of b)
        normB += v * v;
...
function computeMatch(cvText, jobText) {
    if (!(cvText === null || cvText === void 0 ? void 0 : cvText.trim()) || !(jobText === null || jobText === void 0 ? void 0 : jobText.trim())) {
...
function rankJobsForCandidate(candidateText, jobs) {
    if (!(candidateText === null || candidateText === void 0 ? void 0 : candidateText.trim()) || jobs.length === 0)
        return [];
    return jobs
        .map(job => {
...
function rankCandidatesForJob(job, candidates) {
